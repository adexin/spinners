...
export const Scripts = () => {
  [
    'https://unpkg.com/spinners-angular@0.0.5/elements/runtime-es5.js',
    'https://unpkg.com/spinners-angular@0.0.5/elements/polyfills-es5.js',
    'https://unpkg.com/spinners-angular@0.0.5/elements/spinners-es5.js'
  ].map(useScript);
